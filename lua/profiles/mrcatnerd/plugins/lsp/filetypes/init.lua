-- TODO: maybe lazy file loading for autocmd filetype thingy (maybe with a table)
...
require "profiles.mrcatnerd.plugins.lsp.filetypes.go"
require "profiles.mrcatnerd.plugins.lsp.filetypes.xml"
